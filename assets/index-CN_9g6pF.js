...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Jo(e,t,n){let r=new Float32Array(Po),i=new z(0,1,0);return new pa({name:`SphericalGaussianBlur`,defines:{n:Po,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Zo(),fragmentShader:`
	...
	`}var Qo=class extends Ut{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1};this.texture=new Yi([n,n,n,n,n,n]),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};Jl.BlurDirectionX=new R(1,0),Jl.BlurDirectionY=new R(0,1);var Yl=class extends kn{constructor(){super(),this.name=`RoomEnvironment`,this.position.y=-3.5;let e=new ea;e.deleteAttribute(`uv`);let t=new ha({side:1}),n=new ha,r=new Ya(16777215,900,28,2);r.position.set(.418,16.199,.3),this.add(r);let i=new di(e,t);i.position.set(-.757,13.219,.717),i.scale.set(31.713,28.305,28.591),this.add(i);let a=new Ci(e,n,6),o=new bn;o.position.set(-10.906,2.009,1.846),o.rotation.set(0,-.195,0),o.scale.set(2.328,7.905,4.651),o.updateMatrix(),a.setMatrixAt(0,o.matrix),o.position.set(-5.607,-.754,-.758),o.rotation.set(0,.994,0),o.scale.set(1.97,1.534,3.955),o.updateMatrix(),a.setMatrixAt(1,o.matrix),o.position.set(6.167,.857,7.803),o.rotation.set(0,.561,0),o.scale.set(3.927,6.285,3.687),o.updateMatrix(),a.setMatrixAt(2,o.matrix),o.position.set(-2.017,.018,6.124),o.rotation.set(0,.333,0),o.scale.set(2.002,4.566,2.064),o.updateMatrix(),a.setMatrixAt(3,o.matrix),o.position.set(2.291,-.756,-2.621),o.rotation.set(0,-.286,0),o.scale.set(1.546,1.552,1.496),o.updateMatrix(),a.setMatrixAt(4,o.matrix),o.position.set(-2.193,-.369,-5.547),o.rotation.set(0,.516,0),o.scale.set(3.875,3.487,2.986),o.updateMatrix(),a.setMatrixAt(5,o.matrix),this.add(a);let s=new di(e,Xl(50));s.position.set(-16.116,14.37,8.208),s.scale.set(.1,2.428,2.739),this.add(s);let c=new di(e,Xl(50));c.position.set(-16.109,18.021,-8.207),c.scale.set(.1,2.425,2.751),this.add(c);let l=new di(e,Xl(17));l.position.set(14.904,12.198,-1.832),l.scale.set(.15,4.265,6.331),this.add(l);let u=new di(e,Xl(43));u.position.set(-.462,8.89,14.52),u.scale.set(4.38,5.441,.088),this.add(u);let d=new di(e,Xl(20));d.position.set(3.235,11.486,-12.541),d.scale.set(2.5,2,.1),this.add(d);let f=new di(e,Xl(100));f.position.set(0,20,0),f.scale.set(1,.1,1),this.add(f)}dispose(){let e=new Set;this.traverse(t=>{t.isMesh&&(e.add(t.geometry),e.add(t.material))});for(let t of e)t.dispose()}};function Xl(e){return new ga({color:0,emissive:16777215,emissiveIntensity:e})}var Zl=[{a:`mid_shoulder`,b:0,width:.12},{a:`mid_shoulder`,b:`mid_hip`,width:.14},{a:11,b:12,width:.08},{a:23,b:24,width:.09},{a:11,b:13,width:.07},{a:13,b:15,width:.06},{a:12,b:14,width:.07},{a:14,b:16,width:.06},{a:23,b:25,width:.085},{a:25,b:27,width:.075},{a:24,b:26,width:.085},{a:26,b:28,width:.075}],Ql=[11,12,13,14,15,16,23,24,25,26,27,28],$l=new z(0,1,0);function eu(e=10466248){return new ha({color:e,metalness:.2,roughness:.7,emissive:330260})}function tu(e){return new $r({color:e,toneMapped:!1})}var nu=class{constructor(e){this.scene=e,this.group=new xn,this.group.visible=!1,e.add(this.group),this.material=eu(),this.accentMaterial=eu(6125736),this.tintTarget=new H(10466248),this.tintTimer=0,this.bones=Zl.map(e=>{let t=new di(new ta(.5,.5,1,16),this.material);return t.castShadow=!1,this.group.add(t),{def:e,mesh:t}}),this.joints=new Map;for(let e of Ql){let t=new di(new ia(.5,16,12),this.accentMaterial);this.group.add(t),this.joints.set(e,t)}this.head=new di(new ia(.5,24,16),this.material),this.group.add(this.head);let t=new ia(.5,10,8);this.leftEye=new di(t,tu(6741503)),this.rightEye=new di(t,tu(6741503)),this.group.add(this.leftEye),this.group.add(this.rightEye),this.antenna=new di(new ta(.5,.5,1,8),this.accentMaterial),this.group.add(this.antenna),this.antennaTip=new di(new ia(.5,10,8),tu(16737962)),this.group.add(this.antennaTip),this.leftHand=new di(new ia(.5,14,10),this.accentMaterial),this.rightHand=new di(new ia(.5,14,10),this.accentMaterial),this.group.add(this.leftHand),this.group.add(this.rightHand),this._v=new z,this._a=new z,this._b=new z,this._mid=new z,this.filters=null,this.smoothed=null,this._faceImage=null,this._facePlane=null,this._faceTexture=null,this._lastHeadCenter=new z,this._lastHeadSize=.15}setFaceTexture(e){e&&(this._faceImage||(this._faceImage=new Image,this._faceImage.onload=()=>{if(!this._facePlane){let e=new Bt(this._faceImage);e.colorSpace=Qe;let t=new $r({map:e,transparent:!0,depthWrite:!1,toneMapped:!1}),n=new di(new na(1,1),t);n.renderOrder=5,this._facePlane=n,this._faceTexture=e,this.group.add(n)}this._faceTexture.needsUpdate=!0}),this._faceImage.src=e)}clearFaceTexture(){this._facePlane&&(this.group.remove(this._facePlane),this._facePlane.geometry.dispose(),this._facePlane.material.dispose(),this._faceTexture&&this._faceTexture.dispose(),this._facePlane=null,this._faceTexture=null,this._faceImage=null)}smoothLandmarks(e){let t=performance.now();(!this.filters||this.filters.length!==e.length)&&(this.filters=e.map(()=>[new ru,new ru,new ru]),this.smoothed=e.map(e=>({x:e.x,y:e.y,z:e.z,visibility:e.visibility})));for(let n=0;n<e.length;n++){let r=e[n],i=this.filters[n],a=this.smoothed[n];a.x=i[0].filter(r.x,t),a.y=i[1].filter(r.y,t),a.z=i[2].filter(r.z,t),a.visibility=r.visibility}return this.smoothed}setTint(e,t=600){this.tintTarget.setHex(e),this.tintTimer=t}getLandmarkWorld(e,t,n,r=this._v){return t===`mid_shoulder`?au(e[11],e[12],n,r):t===`mid_hip`?au(e[23],e[24],n,r):iu(e[t],n,r)}update(e,t,n){if(!e||e.length<33){this.group.visible=!1,this.smoothed=null,this.filters=null;return}let r=this.smoothLandmarks(e);this.group.visible=!0;for(let{def:e,mesh:n}of this.bones)ou(n,this.getLandmarkWorld(r,e.a,t,this._a),this.getLandmarkWorld(r,e.b,t,this._b),e.width);for(let[e,n]of this.joints){let i=r[e];if(!i||i.visibility<.3){n.visible=!1;continue}n.visible=!0,iu(i,t,n.position);let a=e>=15&&e<=16?0:.06;n.scale.setScalar(a||.06)}let i=iu(r[0],t,this._a),a=au(r[11],r[12],t,this._b),o=iu(r[11],t,this._v).distanceTo(iu(r[12],t,new z)),s=i.clone().lerp(a,-.25),c=Math.max(o*.55,.08);this.head.position.copy(s),this.head.scale.setScalar(c);let l=a.clone().sub(i).normalize().multiplyScalar(0),u=new z(1,0,0),d=new z(0,0,1);this.leftEye.position.copy(s).addScaledVector(u,-c*.35).addScaledVector(d,c*.7).add(l),this.rightEye.position.copy(s).addScaledVector(u,c*.35).addScaledVector(d,c*.7).add(l),this.leftEye.scale.setScalar(c*.18),this.rightEye.scale.setScalar(c*.18);let f=!!this._facePlane;this.leftEye.visible=!f,this.rightEye.visible=!f,this._lastHeadCenter.copy(s),this._lastHeadSize=c,this._facePlane&&(this._facePlane.position.copy(s),this._facePlane.position.z+=c*.55,this._facePlane.scale.setScalar(c*1.27));let p=s.clone().addScaledVector(new z(0,1,0),c*.85),m=p.clone().addScaledVector(new z(0,1,0),c*.9);if(ou(this.antenna,p,m,.02),this.antennaTip.position.copy(m),this.antennaTip.scale.setScalar(.05),r[15]&&r[15].visibility>.3?(iu(r[15],t,this.leftHand.position),this.leftHand.scale.setScalar(.09),this.leftHand.visible=!0):this.leftHand.visible=!1,r[16]&&r[16].visibility>.3?(iu(r[16],t,this.rightHand.position),this.rightHand.scale.setScalar(.09),this.rightHand.visible=!0):this.rightHand.visible=!1,this.tintTimer>0){this.tintTimer-=n;let e=performance.now()*.001%1;this.material.color.setHSL(e,.7,.55),this.accentMaterial.color.setHSL((e+.15)%1,.7,.45),this.tintTimer<=0&&(this.material.color.setHex(10466248),this.accentMaterial.color.setHex(6125736))}}hide(){this.group.visible=!1}dispose(){this.scene.remove(this.group),this.group.traverse(e=>{e.geometry&&e.geometry.dispose(),e.material&&e.material.dispose()})}},ru=class{constructor(e=.6,t=.004,n=1){this.minCutoff=e,this.beta=t,this.dCutoff=n,this.xPrev=null,this.dxPrev=0,this.tPrev=null}_alpha(e,t){let n=2*Math.PI*e*t;return n/(n+1)}filter(e,t){if(this.tPrev===null)return this.tPrev=t,this.xPrev=e,e;let n=Math.max((t-this.tPrev)/1e3,1e-4),r=(e-this.xPrev)/n,i=this._alpha(this.dCutoff,n),a=i*r+(1-i)*this.dxPrev,o=this.minCutoff+this.beta*Math.abs(a),s=this._alpha(o,n),c=s*e+(1-s)*this.xPrev;return this.xPrev=c,this.dxPrev=a,this.tPrev=t,c}};function iu(e,t,n=new z){let r=(.5-e.x)*2*t,i=(.5-e.y)*2,a=-e.z*2;return n.set(r,i,a)}function au(e,t,n,r){let i=iu(e,n,new z);return iu(t,n,r).add(i).multiplyScalar(.5)}function ou(e,t,n,r){let i=t.clone().add(n).multiplyScalar(.5),a=n.clone().sub(t),o=a.length();e.position.copy(i),e.scale.set(r,Math.max(o,.001),r),e.quaternion.setFromUnitVectors($l,a.clone().normalize())}var su=class{constructor(e,t=24,n=180){this.scene=e,this.maxBursts=t,this.particlesPerBurst=n,this.bursts=[];let r=new Cr;this.capacity=t*n,this.positions=new Float32Array(this.capacity*3),this.velocities=new Float32Array(this.capacity*3),this.colors=new Float32Array(this.capacity*3),this.life=new Float32Array(this.capacity),this.maxLife=new Float32Array(this.capacity),r.setAttribute(`position`,new cr(this.positions,3)),r.setAttribute(`color`,new cr(this.colors,3)),this.points=new qi(r,new Hi({size:.05,vertexColors:!0,transparent:!0,opacity:1,blending:2,depthWrite:!1,toneMapped:!1})),this.points.frustumCulled=!1,e.add(this.points),this.nextIndex=0}burst(e,t=new H().setHSL(Math.random(),.9,.6)){let n=this.nextIndex;for(let n=0;n<this.particlesPerBurst;n++){let r=(this.nextIndex+n)%this.capacity,i=r*3;this.positions[i]=e.x,this.positions[i+1]=e.y,this.positions[i+2]=e.z;let a=Math.random()*Math.PI*2,o=Math.acos(2*Math.random()-1),s=.5+Math.random()*1.5;this.velocities[i]=Math.sin(o)*Math.cos(a)*s,this.velocities[i+1]=Math.cos(o)*s,this.velocities[i+2]=Math.sin(o)*Math.sin(a)*s;let c=t.clone();c.offsetHSL((Math.random()-.5)*.12,0,(Math.random()-.5)*.15),this.colors[i]=c.r,this.colors[i+1]=c.g,this.colors[i+2]=c.b;let l=.9+Math.random()*.8;this.life[r]=l,this.maxLife[r]=l}this.nextIndex=(n+this.particlesPerBurst)%this.capacity}update(e){let t=.6**e;for(let n=0;n<this.capacity;n++){if(this.life[n]<=0){let e=n*3;this.positions[e+1]=-9999;continue}this.life[n]-=e;let r=n*3;this.velocities[r]*=t,this.velocities[r+1]=this.velocities[r+1]*t+-1.2*e,this.velocities[r+2]*=t,this.positions[r]+=this.velocities[r]*e,this.positions[r+1]+=this.velocities[r+1]*e,this.positions[r+2]+=this.velocities[r+2]*e,Math.max(this.life[n]/this.maxLife[n],0),this.colors[r]*=.995,this.colors[r+1]*=.995,this.colors[r+2]*=.995}this.points.geometry.attributes.position.needsUpdate=!0,this.points.geometry.attributes.color.needsUpdate=!0}},cu={uniforms:{tDiffuse:{value:null},uTime:{value:0},uStrength:{value:0}},vertexShader:`
    varying vec2 vUv;
    void main() {
      vUv = uv;
      gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
...
s=-\r
t=0 0\r
`},n.getDirection=function(e,t){let r=n.splitLines(e);for(let e=0;e<r.length;e++)switch(r[e]){case`a=sendrecv`:case`a=sendonly`:case`a=recvonly`:case`a=inactive`:return r[e].substring(2);default:}return t?n.getDirection(t):`sendrecv`},n.getKind=function(e){return n.splitLines(e)[0].split(` `)[0].substring(2)},n.isRejected=function(e){return e.split(` `,2)[1]===`0`},n.parseMLine=function(e){let t=n.splitLines(e)[0].substring(2).split(` `);return{kind:t[0],port:parseInt(t[1],10),protocol:t[2],fmt:t.slice(3).join(` `)}},n.parseOLine=function(e){let t=n.matchPrefix(e,`o=`)[0].substring(2).split(` `);return{username:t[0],sessionId:t[1],sessionVersion:parseInt(t[2],10),netType:t[3],addressType:t[4],address:t[5]}},n.isValidSDP=function(e){if(typeof e!=`string`||e.length===0)return!1;let t=n.splitLines(e);for(let e=0;e<t.length;e++)if(t[e].length<2||t[e].charAt(1)!==`=`)return!1;return!0},typeof t==`object`&&(t.exports=n)})),hx=s({removeExtmapAllowMixed:()=>Sx,shimAddIceCandidateNullOrEmpty:()=>Cx,shimConnectionState:()=>xx,shimMaxMessageSize:()=>yx,shimParameterlessSetLocalDescription:()=>wx,shimRTCIceCandidate:()=>_x,shimRTCIceCandidateRelayProtocol:()=>vx,shimSendThrowTypeError:()=>bx}),gx=l(mx());function _x(e){if(!e.RTCIceCandidate||e.RTCIceCandidate&&`foundation`in e.RTCIceCandidate.prototype)return;let t=e.RTCIceCandidate;e.RTCIceCandidate=function(e){if(typeof e==`object`&&e.candidate&&e.candidate.indexOf(`a=`)===0&&(e=JSON.parse(JSON.stringify(e)),e.candidate=e.candidate.substring(2)),e.candidate&&e.candidate.length){let n=new t(e),r=gx.default.parseCandidate(e.candidate);for(let e in r)e in n||Object.defineProperty(n,e,{value:r[e]});return n.toJSON=function(){return{candidate:n.candidate,sdpMid:n.sdpMid,sdpMLineIndex:n.sdpMLineIndex,usernameFragment:n.usernameFragment}},n}return new t(e)},e.RTCIceCandidate.prototype=t.prototype,wb(e,`icecandidate`,t=>(t.candidate&&Object.defineProperty(t,`candidate`,{value:new e.RTCIceCandidate(t.candidate),writable:`false`}),t))}function vx(e){!e.RTCIceCandidate||e.RTCIceCandidate&&`relayProtocol`in e.RTCIceCandidate.prototype||wb(e,`icecandidate`,e=>{if(e.candidate){let t=gx.default.parseCandidate(e.candidate.candidate);t.type===`relay`&&(e.candidate.relayProtocol={0:`tls`,1:`tcp`,2:`udp`}[t.priority>>24])}return e})}function yx(e,t){if(!e.RTCPeerConnection)return;`sctp`in e.RTCPeerConnection.prototype||Object.defineProperty(e.RTCPeerConnection.prototype,`sctp`,{get(){return this._sctp===void 0?null:this._sctp}});let n=function(e){if(!e||!e.sdp)return!1;let t=gx.default.splitSections(e.sdp);return t.shift(),t.some(e=>{let t=gx.default.parseMLine(e);return t&&t.kind===`application`&&t.protocol.indexOf(`SCTP`)!==-1})},r=function(e){let t=e.sdp.match(/mozilla...THIS_IS_SDPARTA-(\d+)/);if(t===null||t.length<2)return-1;let n=parseInt(t[1],10);return n===n?n:-1},i=function(e){let n=65536;return t.browser===`firefox`&&(n=t.version<57?e===-1?16384:2147483637:t.version<60?t.version===57?65535:65536:2147483637),n},a=function(e,n){let r=65536;t.browser===`firefox`&&t.version===57&&(r=65535);let i=gx.default.matchPrefix(e.sdp,`a=max-message-size:`);return i.length>0?r=parseInt(i[0].substring(19),10):t.browser===`firefox`&&n!==-1&&(r=2147483637),r},o=e.RTCPeerConnection.prototype.setRemoteDescription;e.RTCPeerConnection.prototype.setRemoteDescription=function(){if(this._sctp=null,t.browser===`chrome`&&t.version>=76){let{sdpSemantics:e}=this.getConfiguration();e===`plan-b`&&Object.defineProperty(this,`sctp`,{get(){return this._sctp===void 0?null:this._sctp},enumerable:!0,configurable:!0})}if(n(arguments[0])){let e=r(arguments[0]),t=i(e),n=a(arguments[0],e),o;o=t===0&&n===0?1/0:t===0||n===0?Math.max(t,n):Math.min(t,n);let s={};Object.defineProperty(s,`maxMessageSize`,{get(){return o}}),this._sctp=s}return o.apply(this,arguments)}}function bx(e){if(!(e.RTCPeerConnection&&`createDataChannel`in e.RTCPeerConnection.prototype))return;function t(e,t){let n=e.send;e.send=function(){let r=arguments[0],i=r.length||r.size||r.byteLength;if(e.readyState===`open`&&t.sctp&&i>t.sctp.maxMessageSize)throw TypeError(`Message too large (can send a maximum of `+t.sctp.maxMessageSize+` bytes)`);return n.apply(e,arguments)}}let n=e.RTCPeerConnection.prototype.createDataChannel;e.RTCPeerConnection.prototype.createDataChannel=function(){let e=n.apply(this,arguments);return t(e,this),e},wb(e,`datachannel`,e=>(t(e.channel,e.target),e))}function xx(e){if(!e.RTCPeerConnection||`connectionState`in e.RTCPeerConnection.prototype)return;let t=e.RTCPeerConnection.prototype;Object.defineProperty(t,`connectionState`,{get(){return{completed:`connected`,checking:`connecting`}[this.iceConnectionState]||this.iceConnectionState},enumerable:!0,configurable:!0}),Object.defineProperty(t,`onconnectionstatechange`,{get(){return this._onconnectionstatechange||null},set(e){this._onconnectionstatechange&&(this.removeEventListener(`connectionstatechange`,this._onconnectionstatechange),delete this._onconnectionstatechange),e&&this.addEventListener(`connectionstatechange`,this._onconnectionstatechange=e)},enumerable:!0,configurable:!0}),[`setLocalDescription`,`setRemoteDescription`].forEach(e=>{let n=t[e];t[e]=function(){return this._connectionstatechangepoly||(this._connectionstatechangepoly=e=>{let t=e.target;if(t._lastConnectionState!==t.connectionState){t._lastConnectionState=t.connectionState;let n=new Event(`connectionstatechange`,e);t.dispatchEvent(n)}return e},this.addEventListener(`iceconnectionstatechange`,this._connectionstatechangepoly)),n.apply(this,arguments)}})}function Sx(e,t){if(!e.RTCPeerConnection||t.browser===`chrome`&&t.version>=71||t.browser===`safari`&&t._safariVersion>=13.1)return;let n=e.RTCPeerConnection.prototype.setRemoteDescription;e.RTCPeerConnection.prototype.setRemoteDescription=function(t){if(t&&t.sdp&&t.sdp.indexOf(`
a=extmap-allow-mixed`)!==-1){let n=t.sdp.split(`
`).filter(e=>e.trim()!==`a=extmap-allow-mixed`).join(`
`);e.RTCSessionDescription&&t instanceof e.RTCSessionDescription?arguments[0]=new e.RTCSessionDescription({type:t.type,sdp:n}):t.sdp=n}return n.apply(this,arguments)}}function Cx(e,t){if(!(e.RTCPeerConnection&&e.RTCPeerConnection.prototype))return;let n=e.RTCPeerConnection.prototype.addIceCandidate;!n||n.length===0||(e.RTCPeerConnection.prototype.addIceCandidate=function(){return arguments[0]?(t.browser===`chrome`&&t.version<78||t.browser===`firefox`&&t.version<68||t.browser===`safari`)&&arguments[0]&&arguments[0].candidate===``?Promise.resolve():n.apply(this,arguments):(arguments[1]&&arguments[1].apply(null),Promise.resolve())})}function wx(e,t){if(!(e.RTCPeerConnection&&e.RTCPeerConnection.prototype))return;let n=e.RTCPeerConnection.prototype.setLocalDescription;!n||n.length===0||(e.RTCPeerConnection.prototype.setLocalDescription=function(){let e=arguments[0]||{};if(typeof e!=`object`||e.type&&e.sdp)return n.apply(this,arguments);if(e={type:e.type,sdp:e.sdp},!e.type)switch(this.signalingState){case`stable`:case`have-local-offer`:case`have-remote-pranswer`:e.type=`offer`;break;default:e.type=`answer`;break}return e.sdp||e.type!==`offer`&&e.type!==`answer`?n.apply(this,[e]):(e.type===`offer`?this.createOffer:this.createAnswer).apply(this).then(e=>n.apply(this,[e]))})}function Tx({window:e}={},t={shimChrome:!0,shimFirefox:!0,shimSafari:!0}){let n=Db,r=kb(e),i={browserDetails:r,commonShim:hx,extractVersion:Cb,disableLog:Tb,disableWarnings:Eb,sdp:gx};switch(r.browser){case`chrome`:if(!Ib||!Ub||!t.shimChrome)return n(`Chrome shim is not included in this adapter release.`),i;if(r.version===null)return n(`Chrome shim can not determine version, not shimming.`),i;n(`adapter.js shimming chrome.`),i.browserShim=Ib,Cx(e,r),wx(e,r),Fb(e,r),Lb(e,r),Ub(e,r),Rb(e,r),Hb(e,r),zb(e,r),Bb(e,r),Wb(e,r),_x(e,r),vx(e,r),xx(e,r),yx(e,r),bx(e,r),Sx(e,r);break;case`firefox`:if(!qb||!Yb||!t.shimFirefox)return n(`Firefox shim is not included in this adapter release.`),i;n(`adapter.js shimming firefox.`),i.browserShim=qb,Cx(e,r),wx(e,r),Gb(e,r),Yb(e,r),Jb(e,r),Qb(e,r),Xb(e,r),Zb(e,r),$b(e,r),ex(e,r),tx(e,r),nx(e,r),rx(e,r),_x(e,r),xx(e,r),yx(e,r),bx(e,r);break;case`safari`:if(!ix||!t.shimSafari)return n(`Safari shim is not included in this adapter release.`),i;n(`adapter.js shimming safari.`),i.browserShim=ix,Cx(e,r),wx(e,r),ux(e,r),fx(e,r),sx(e,r),ax(e,r),ox(e,r),dx(e,r),cx(e,r),px(e,r),_x(e,r),vx(e,r),yx(e,r),bx(e,r),Sx(e,r);break;default:n(`Unsupported browser!`);break}return i}var Ex=Tx({window:typeof window>`u`?void 0:window});function Dx(e,t,n,r){Object.defineProperty(e,t,{get:n,set:r,enumerable:!0,configurable:!0})}var Ox=class{constructor(){this.chunkedMTU=16300,this._dataCount=1,this.chunk=e=>{let t=[],n=e.byteLength,r=Math.ceil(n/this.chunkedMTU),i=0,a=0;for(;a<n;){let o=Math.min(n,a+this.chunkedMTU),s=e.slice(a,o),c={__peerData:this._dataCount,n:i,data:s,total:r};t.push(c),a=o,i++}return this._dataCount++,t}}};function kx(e){let t=0;for(let n of e)t+=n.byteLength;let n=new Uint8Array(t),r=0;for(let t of e)n.set(t,r),r+=t.byteLength;return n}var Ax=Ex.default||Ex,jx=new class{isWebRTCSupported(){return typeof RTCPeerConnection<`u`}isBrowserSupported(){let e=this.getBrowser(),t=this.getVersion();return this.supportedBrowsers.includes(e)?e===`chrome`?t>=this.minChromeVersion:e===`firefox`?t>=this.minFirefoxVersion:e===`safari`?!this.isIOS&&t>=this.minSafariVersion:!1:!1}getBrowser(){return Ax.browserDetails.browser}getVersion(){return Ax.browserDetails.version||0}isUnifiedPlanSupported(){let e=this.getBrowser(),t=Ax.browserDetails.version||0;if(e===`chrome`&&t<this.minChromeVersion)return!1;if(e===`firefox`&&t>=this.minFirefoxVersion)return!0;if(!window.RTCRtpTransceiver||!(`currentDirection`in RTCRtpTransceiver.prototype))return!1;let n,r=!1;try{n=new RTCPeerConnection,n.addTransceiver(`audio`),r=!0}catch{}finally{n&&n.close()}return r}toString(){return`Supports:
    browser:${this.getBrowser()}
    version:${this.getVersion()}
    isIOS:${this.isIOS}
    isWebRTCSupported:${this.isWebRTCSupported()}
    isBrowserSupported:${this.isBrowserSupported()}
    isUnifiedPlanSupported:${this.isUnifiedPlanSupported()}`}constructor(){this.isIOS=typeof navigator<`u`?[`iPad`,`iPhone`,`iPod`].includes(navigator.platform):!1,this.supportedBrowsers=[`firefox`,`chrome`,`safari`],this.minFirefoxVersion=59,this.minChromeVersion=72,this.minSafariVersion=605}},Mx=e=>!e||/^[A-Za-z0-9]+(?:[ _-][A-Za-z0-9]+)*$/.test(e),Nx=()=>Math.random().toString(36).slice(2),Px={iceServers:[{urls:`stun:stun.l.google.com:19302`},{urls:[`turn:eu-0.turn.peerjs.com:3478`,`turn:us-0.turn.peerjs.com:3478`],username:`peerjs`,credential:`peerjsp`}],sdpSemantics:`unified-plan`},Fx=new class extends Ox{noop(){}blobToArrayBuffer(e,t){let n=new FileReader;return n.onload=function(e){e.target&&t(e.target.result)},n.readAsArrayBuffer(e),n}binaryStringToArrayBuffer(e){let t=new Uint8Array(e.length);for(let n=0;n<e.length;n++)t[n]=e.charCodeAt(n)&255;return t.buffer}isSecure(){return location.protocol===`https:`}constructor(...e){super(...e),this.CLOUD_HOST=`0.peerjs.com`,this.CLOUD_PORT=443,this.chunkedBrowsers={Chrome:1,chrome:1},this.defaultConfig=Px,this.browser=jx.getBrowser(),this.browserVersion=jx.getVersion(),this.pack=vb,this.unpack=_b,this.supports=function(){let e={browser:jx.isBrowserSupported(),webRTC:jx.isWebRTCSupported(),audioVideo:!1,data:!1,binaryBlob:!1,reliable:!1};if(!e.webRTC)return e;let t;try{t=new RTCPeerConnection(Px),e.audioVideo=!0;let n;try{n=t.createDataChannel(`_PEERJSTEST`,{ordered:!0}),e.data=!0,e.reliable=!!n.ordered;try{n.binaryType=`blob`,e.binaryBlob=!jx.isIOS}catch{}}catch{}finally{n&&n.close()}}catch{}finally{t&&t.close()}return e}(),this.validateId=Mx,this.randomToken=Nx}},Ix=`PeerJS: `,$=new class{get logLevel(){return this._logLevel}set logLevel(e){this._logLevel=e}log(...e){this._logLevel>=3&&this._print(3,...e)}warn(...e){this._logLevel>=2&&this._print(2,...e)}error(...e){this._logLevel>=1&&this._print(1,...e)}setLogFunction(e){this._print=e}_print(e,...t){let n=[Ix,...t];for(let e in n)n[e]instanceof Error&&(n[e]=`(`+n[e].name+`) `+n[e].message);e>=3?console.log(...n):e>=2?console.warn(`WARNING`,...n):e>=1&&console.error(`ERROR`,...n)}constructor(){this._logLevel=0}},Lx={},Rx=Object.prototype.hasOwnProperty,zx=`~`;function Bx(){}Object.create&&(Bx.prototype=Object.create(null),new Bx().__proto__||(zx=!1));function Vx(e,t,n){this.fn=e,this.context=t,this.once=n||!1}function Hx(e,t,n,r,i){if(typeof n!=`function`)throw TypeError(`The listener must be a function`);var a=new Vx(n,r||e,i),o=zx?zx+t:t;return e._events[o]?e._events[o].fn?e._events[o]=[e._events[o],a]:e._events[o].push(a):(e._events[o]=a,e._eventsCount++),e}function Ux(e,t){--e._eventsCount===0?e._events=new Bx:delete e._events[t]}function Wx(){this._events=new Bx,this._eventsCount=0}Wx.prototype.eventNames=function(){var e=[],t,n;if(this._eventsCount===0)return e;for(n in t=this._events)Rx.call(t,n)&&e.push(zx?n.slice(1):n);return Object.getOwnPropertySymbols?e.concat(Object.getOwnPropertySymbols(t)):e},Wx.prototype.listeners=function(e){var t=zx?zx+e:e,n=this._events[t];if(!n)return[];if(n.fn)return[n.fn];for(var r=0,i=n.length,a=Array(i);r<i;r++)a[r]=n[r].fn;return a},Wx.prototype.listenerCount=function(e){var t=zx?zx+e:e,n=this._events[t];return n?n.fn?1:n.length:0},Wx.prototype.emit=function(e,t,n,r,i,a){var o=zx?zx+e:e;if(!this._events[o])return!1;var s=this._events[o],c=arguments.length,l,u;if(s.fn){switch(s.once&&this.removeListener(e,s.fn,void 0,!0),c){case 1:return s.fn.call(s.context),!0;case 2:return s.fn.call(s.context,t),!0;case 3:return s.fn.call(s.context,t,n),!0;case 4:return s.fn.call(s.context,t,n,r),!0;case 5:return s.fn.call(s.context,t,n,r,i),!0;case 6:return s.fn.call(s.context,t,n,r,i,a),!0}for(u=1,l=Array(c-1);u<c;u++)l[u-1]=arguments[u];s.fn.apply(s.context,l)}else{var d=s.length,f;for(u=0;u<d;u++)switch(s[u].once&&this.removeListener(e,s[u].fn,void 0,!0),c){case 1:s[u].fn.call(s[u].context);break;case 2:s[u].fn.call(s[u].context,t);break;case 3:s[u].fn.call(s[u].context,t,n);break;case 4:s[u].fn.call(s[u].context,t,n,r);break;default:if(!l)for(f=1,l=Array(c-1);f<c;f++)l[f-1]=arguments[f];s[u].fn.apply(s[u].context,l)}}return!0},Wx.prototype.on=function(e,t,n){return Hx(this,e,t,n,!1)},Wx.prototype.once=function(e,t,n){return Hx(this,e,t,n,!0)},Wx.prototype.removeListener=function(e,t,n,r){var i=zx?zx+e:e;if(!this._events[i])return this;if(!t)return Ux(this,i),this;var a=this._events[i];if(a.fn)a.fn===t&&(!r||a.once)&&(!n||a.context===n)&&Ux(this,i);else{for(var o=0,s=[],c=a.length;o<c;o++)(a[o].fn!==t||r&&!a[o].once||n&&a[o].context!==n)&&s.push(a[o]);s.length?this._events[i]=s.length===1?s[0]:s:Ux(this,i)}return this},Wx.prototype.removeAllListeners=function(e){var t;return e?(t=zx?zx+e:e,this._events[t]&&Ux(this,t)):(this._events=new Bx,this._eventsCount=0),this},Wx.prototype.off=Wx.prototype.removeListener,Wx.prototype.addListener=Wx.prototype.on,Wx.prefixed=zx,Wx.EventEmitter=Wx,Lx=Wx;var Gx={};Dx(Gx,`ConnectionType`,()=>Kx),Dx(Gx,`PeerErrorType`,()=>qx),Dx(Gx,`BaseConnectionErrorType`,()=>Jx),Dx(Gx,`DataConnectionErrorType`,()=>Yx),Dx(Gx,`SerializationType`,()=>Xx),Dx(Gx,`SocketEventType`,()=>Zx),Dx(Gx,`ServerMessageType`,()=>Qx);var Kx=function(e){return e.Data=`data`,e.Media=`media`,e}({}),qx=function(e){return e.BrowserIncompatible=`browser-incompatible`,e.Disconnected=`disconnected`,e.InvalidID=`invalid-id`,e.InvalidKey=`invalid-key`,e.Network=`network`,e.PeerUnavailable=`peer-unavailable`,e.SslUnavailable=`ssl-unavailable`,e.ServerError=`server-error`,e.SocketError=`socket-error`,e.SocketClosed=`socket-closed`,e.UnavailableID=`unavailable-id`,e.WebRTC=`webrtc`,e}({}),Jx=function(e){return e.NegotiationFailed=`negotiation-failed`,e.ConnectionClosed=`connection-closed`,e}({}),Yx=function(e){return e.NotOpenYet=`not-open-yet`,e.MessageToBig=`message-too-big`,e}({}),Xx=function(e){return e.Binary=`binary`,e.BinaryUTF8=`binary-utf8`,e.JSON=`json`,e.None=`raw`,e}({}),Zx=function(e){return e.Message=`message`,e.Disconnected=`disconnected`,e.Error=`error`,e.Close=`close`,e}({}),Qx=function(e){return e.Heartbeat=`HEARTBEAT`,e.Candidate=`CANDIDATE`,e.Offer=`OFFER`,e.Answer=`ANSWER`,e.Open=`OPEN`,e.Error=`ERROR`,e.IdTaken=`ID-TAKEN`,e.InvalidKey=`INVALID-KEY`,e.Leave=`LEAVE`,e.Expire=`EXPIRE`,e}({}),$x=`1.5.5`,eS=class extends Lx.EventEmitter{constructor(e,t,n,r,i,a=5e3){super(),this.pingInterval=a,this._disconnected=!0,this._messagesQueue=[],this._baseUrl=(e?`wss://`:`ws://`)+t+`:`+n+r+`peerjs?key=`+i}start(e,t){this._id=e;let n=`${this._baseUrl}&id=${e}&token=${t}`;this._socket||!this._disconnected||(this._socket=new WebSocket(n+`&version=1.5.5`),this._disconnected=!1,this._socket.onmessage=e=>{let t;try{t=JSON.parse(e.data),$.log(`Server message received:`,t)}catch{$.log(`Invalid server message`,e.data);return}this.emit(Zx.Message,t)},this._socket.onclose=e=>{this._disconnected||($.log(`Socket closed.`,e),this._cleanup(),this._disconnected=!0,this.emit(Zx.Disconnected))},this._socket.onopen=()=>{this._disconnected||(this._sendQueuedMessages(),$.log(`Socket open`),this._scheduleHeartbeat())})}_scheduleHeartbeat(){this._wsPingTimer=setTimeout(()=>{this._sendHeartbeat()},this.pingInterval)}_sendHeartbeat(){if(!this._wsOpen()){$.log(`Cannot send heartbeat, because socket closed`);return}let e=JSON.stringify({type:Qx.Heartbeat});this._socket.send(e),this._scheduleHeartbeat()}_wsOpen(){return!!this._socket&&this._socket.readyState===1}_sendQueuedMessages(){let e=[...this._messagesQueue];this._messagesQueue=[];for(let t of e)this.send(t)}send(e){if(this._disconnected)return;if(!this._id){this._messagesQueue.push(e);return}if(!e.type){this.emit(Zx.Error,`Invalid message`);return}if(!this._wsOpen())return;let t=JSON.stringify(e);this._socket.send(t)}close(){this._disconnected||=(this._cleanup(),!0)}_cleanup(){this._socket&&=(this._socket.onopen=this._socket.onmessage=this._socket.onclose=null,this._socket.close(),void 0),clearTimeout(this._wsPingTimer)}},tS=class{constructor(e){this.connection=e}startConnection(e){let t=this._startPeerConnection();if(this.connection.peerConnection=t,this.connection.type===Kx.Media&&e._stream&&this._addTracksToConnection(e._stream,t),e.originator){let n=this.connection,r={ordered:!!e.reliable},i=t.createDataChannel(n.label,r);n._initializeDataChannel(i),this._makeOffer()}else this.handleSDP(`OFFER`,e.sdp)}_startPeerConnection(){$.log(`Creating RTCPeerConnection.`);let e=new RTCPeerConnection(this.connection.provider.options.config);return this._setupListeners(e),e}_setupListeners(e){let t=this.connection.peer,n=this.connection.connectionId,r=this.connection.type,i=this.connection.provider;$.log(`Listening for ICE candidates.`),e.onicecandidate=e=>{!e.candidate||!e.candidate.candidate||($.log(`Received ICE candidates for ${t}:`,e.candidate),i.socket.send({type:Qx.Candidate,payload:{candidate:e.candidate,type:r,connectionId:n},dst:t}))},e.oniceconnectionstatechange=()=>{switch(e.iceConnectionState){case`failed`:$.log(`iceConnectionState is failed, closing connections to `+t),this.connection.emitError(Jx.NegotiationFailed,`Negotiation of connection to `+t+` failed.`),this.connection.close();break;case`closed`:$.log(`iceConnectionState is closed, closing connections to `+t),this.connection.emitError(Jx.ConnectionClosed,`Connection to `+t+` closed.`),this.connection.close();break;case`disconnected`:$.log(`iceConnectionState changed to disconnected on the connection with `+t);break;case`completed`:e.onicecandidate=()=>{};break}this.connection.emit(`iceStateChanged`,e.iceConnectionState)},$.log(`Listening for data channel`),e.ondatachannel=e=>{$.log(`Received data channel`);let r=e.channel;i.getConnection(t,n)._initializeDataChannel(r)},$.log(`Listening for remote stream`),e.ontrack=e=>{$.log(`Received remote stream`);let r=e.streams[0],a=i.getConnection(t,n);if(a.type===Kx.Media){let e=a;this._addStreamToMediaConnection(r,e)}}}cleanup(){$.log(`Cleaning up PeerConnection to `+this.connection.peer);let e=this.connection.peerConnection;if(!e)return;this.connection.peerConnection=null,e.onicecandidate=e.oniceconnectionstatechange=e.ondatachannel=e.ontrack=()=>{};let t=e.signalingState!==`closed`,n=!1,r=this.connection.dataChannel;r&&(n=!!r.readyState&&r.readyState!==`closed`),(t||n)&&e.close()}async _makeOffer(){let e=this.connection.peerConnection,t=this.connection.provider;try{let n=await e.createOffer(this.connection.options.constraints);$.log(`Created offer.`),this.connection.options.sdpTransform&&typeof this.connection.options.sdpTransform==`function`&&(n.sdp=this.connection.options.sdpTransform(n.sdp)||n.sdp);try{await e.setLocalDescription(n),$.log(`Set localDescription:`,n,`for:${this.connection.peer}`);let r={sdp:n,type:this.connection.type,connectionId:this.connection.connectionId,metadata:this.connection.metadata};if(this.connection.type===Kx.Data){let e=this.connection;r={...r,label:e.label,reliable:e.reliable,serialization:e.serialization}}t.socket.send({type:Qx.Offer,payload:r,dst:this.connection.peer})}catch(e){e!=`OperationError: Failed to set local offer sdp: Called in wrong state: kHaveRemoteOffer`&&(t.emitError(qx.WebRTC,e),$.log(`Failed to setLocalDescription, `,e))}}catch(e){t.emitError(qx.WebRTC,e),$.log(`Failed to createOffer, `,e)}}async _makeAnswer(){let e=this.connection.peerConnection,t=this.connection.provider;try{let n=await e.createAnswer();$.log(`Created answer.`),this.connection.options.sdpTransform&&typeof this.connection.options.sdpTransform==`function`&&(n.sdp=this.connection.options.sdpTransform(n.sdp)||n.sdp);try{await e.setLocalDescription(n),$.log(`Set localDescription:`,n,`for:${this.connection.peer}`),t.socket.send({type:Qx.Answer,payload:{sdp:n,type:this.connection.type,connectionId:this.connection.connectionId},dst:this.connection.peer})}catch(e){t.emitError(qx.WebRTC,e),$.log(`Failed to setLocalDescription, `,e)}}catch(e){t.emitError(qx.WebRTC,e),$.log(`Failed to create answer, `,e)}}async handleSDP(e,t){t=new RTCSessionDescription(t);let n=this.connection.peerConnection,r=this.connection.provider;$.log(`Setting remote description`,t);let i=this;try{await n.setRemoteDescription(t),$.log(`Set remoteDescription:${e} for:${this.connection.peer}`),e===`OFFER`&&await i._makeAnswer()}catch(e){r.emitError(qx.WebRTC,e),$.log(`Failed to setRemoteDescription, `,e)}}async handleCandidate(e){$.log(`handleCandidate:`,e);try{await this.connection.peerConnection.addIceCandidate(e),$.log(`Added ICE candidate for:${this.connection.peer}`)}catch(e){this.connection.provider.emitError(qx.WebRTC,e),$.log(`Failed to handleCandidate, `,e)}}_addTracksToConnection(e,t){if($.log(`add tracks from stream ${e.id} to peer connection`),!t.addTrack)return $.error(`Your browser does't support RTCPeerConnection#addTrack. Ignored.`);e.getTracks().forEach(n=>{t.addTrack(n,e)})}_addStreamToMediaConnection(e,t){$.log(`add stream ${e.id} to media connection ${t.connectionId}`),t.addStream(e)}},nS=class extends Lx.EventEmitter{emitError(e,t){$.error(`Error:`,t),this.emit(`error`,new rS(`${e}`,t))}},rS=class extends Error{constructor(e,t){typeof t==`string`?super(t):(super(),Object.assign(this,t)),this.type=e}},iS=class extends nS{get open(){return this._open}constructor(e,t,n){super(),this.peer=e,this.provider=t,this.options=n,this._open=!1,this.metadata=n.metadata}},aS=class e extends iS{static#e=this.ID_PREFIX=`mc_`;get type(){return Kx.Media}get localStream(){return this._localStream}get remoteStream(){return this._remoteStream}constructor(t,n,r){super(t,n,r),this._localStream=this.options._stream,this.connectionId=this.options.connectionId||e.ID_PREFIX+Fx.randomToken(),this._negotiator=new tS(this),this._localStream&&this._negotiator.startConnection({_stream:this._localStream,originator:!0})}_initializeDataChannel(e){this.dataChannel=e,this.dataChannel.onopen=()=>{$.log(`DC#${this.connectionId} dc connection success`),this.emit(`willCloseOnRemote`)},this.dataChannel.onclose=()=>{$.log(`DC#${this.connectionId} dc closed for:`,this.peer),this.close()}}addStream(e){$.log(`Receiving stream`,e),this._remoteStream=e,super.emit(`stream`,e)}handleMessage(e){let t=e.type,n=e.payload;switch(e.type){case Qx.Answer:this._negotiator.handleSDP(t,n.sdp),this._open=!0;break;case Qx.Candidate:this._negotiator.handleCandidate(n.candidate);break;default:$.warn(`Unrecognized message type:${t} from peer:${this.peer}`);break}}answer(e,t={}){if(this._localStream){$.warn(`Local stream already exists on this MediaConnection. Are you answering a call twice?`);return}this._localStream=e,t&&t.sdpTransform&&(this.options.sdpTransform=t.sdpTransform),this._negotiator.startConnection({...this.options._payload,_stream:e});let n=this.provider._getMessages(this.connectionId);for(let e of n)this.handleMessage(e);this._open=!0}close(){this._negotiator&&=(this._negotiator.cleanup(),null),this._localStream=null,this._remoteStream=null,this.provider&&=(this.provider._removeConnection(this),null),this.options&&this.options._stream&&(this.options._stream=null),this.open&&(this._open=!1,super.emit(`close`))}},oS=class{constructor(e){this._options=e}_buildRequest(e){let t=this._options.secure?`https`:`http`,{host:n,port:r,path:i,key:a}=this._options,o=new URL(`${t}://${n}:${r}${i}${a}/${e}`);return o.searchParams.set(`ts`,`${Date.now()}${Math.random()}`),o.searchParams.set(`version`,$x),fetch(o.href,{referrerPolicy:this._options.referrerPolicy})}async retrieveId(){try{let e=await this._buildRequest(`id`);if(e.status!==200)throw Error(`Error. Status:${e.status}`);return e.text()}catch(e){$.error(`Error retrieving ID`,e);let t=``;throw this._options.path===`/`&&this._options.host!==Fx.CLOUD_HOST&&(t=" If you passed in a `path` to your self-hosted PeerServer, you'll also need to pass in that same path when creating a new Peer."),Error(`Could not get an ID from the server.`+t)}}async listAllPeers(){try{let e=await this._buildRequest(`peers`);if(e.status!==200){if(e.status===401){let e=``;throw e=this._options.host===Fx.CLOUD_HOST?`It looks like you're using the cloud server. You can email team@peerjs.com to enable peer listing for your API key.`:"You need to enable `allow_discovery` on your self-hosted PeerServer to use this feature.",Error(`It doesn't look like you have permission to list peers IDs. `+e)}throw Error(`Error. Status:${e.status}`)}return e.json()}catch(e){throw $.error(`Error retrieving list peers`,e),Error(`Could not get list peers from the server.`+e)}}},sS=class e extends iS{static#e=this.ID_PREFIX=`dc_`;static#t=this.MAX_BUFFERED_AMOUNT=8388608;get type(){return Kx.Data}constructor(t,n,r){super(t,n,r),this.connectionId=this.options.connectionId||e.ID_PREFIX+Nx(),this.label=this.options.label||this.connectionId,this.reliable=!!this.options.reliable,this._negotiator=new tS(this),this._negotiator.startConnection(this.options._payload||{originator:!0,reliable:this.reliable})}_initializeDataChannel(e){this.dataChannel=e,this.dataChannel.onopen=()=>{$.log(`DC#${this.connectionId} dc connection success`),this._open=!0,this.emit(`open`)},this.dataChannel.onmessage=e=>{$.log(`DC#${this.connectionId} dc onmessage:`,e.data)},this.dataChannel.onclose=()=>{$.log(`DC#${this.connectionId} dc closed for:`,this.peer),this.close()}}close(e){if(e?.flush){this.send({__peerData:{type:`close`}});return}this._negotiator&&=(this._negotiator.cleanup(),null),this.provider&&=(this.provider._removeConnection(this),null),this.dataChannel&&=(this.dataChannel.onopen=null,this.dataChannel.onmessage=null,this.dataChannel.onclose=null,null),this.open&&(this._open=!1,super.emit(`close`))}send(e,t=!1){if(!this.open){this.emitError(Yx.NotOpenYet,"Connection is not open. You should listen for the `open` event before sending messages.");return}return this._send(e,t)}async handleMessage(e){let t=e.payload;switch(e.type){case Qx.Answer:await this._negotiator.handleSDP(e.type,t.sdp);break;case Qx.Candidate:await this._negotiator.handleCandidate(t.candidate);break;default:$.warn(`Unrecognized message type:`,e.type,`from peer:`,this.peer);break}}},cS=class extends sS{get bufferSize(){return this._bufferSize}_initializeDataChannel(e){super._initializeDataChannel(e),this.dataChannel.binaryType=`arraybuffer`,this.dataChannel.addEventListener(`message`,e=>this._handleDataMessage(e))}_bufferedSend(e){(this._buffering||!this._trySend(e))&&(this._buffer.push(e),this._bufferSize=this._buffer.length)}_trySend(e){if(!this.open)return!1;if(this.dataChannel.bufferedAmount>sS.MAX_BUFFERED_AMOUNT)return this._buffering=!0,setTimeout(()=>{this._buffering=!1,this._tryBuffer()},50),!1;try{this.dataChannel.send(e)}catch(e){return $.error(`DC#:${this.connectionId} Error when sending:`,e),this._buffering=!0,this.close(),!1}return!0}_tryBuffer(){if(!this.open||this._buffer.length===0)return;let e=this._buffer[0];this._trySend(e)&&(this._buffer.shift(),this._bufferSize=this._buffer.length,this._tryBuffer())}close(e){if(e?.flush){this.send({__peerData:{type:`close`}});return}this._buffer=[],this._bufferSize=0,super.close()}constructor(...e){super(...e),this._buffer=[],this._bufferSize=0,this._buffering=!1}},lS=class extends cS{close(e){super.close(e),this._chunkedData={}}constructor(e,t,n){super(e,t,n),this.chunker=new Ox,this.serialization=Xx.Binary,this._chunkedData={}}_handleDataMessage({data:e}){let t=_b(e),n=t.__peerData;if(n){if(n.type===`close`){this.close();return}this._handleChunk(t);return}this.emit(`data`,t)}_handleChunk(e){let t=e.__peerData,n=this._chunkedData[t]||{data:[],count:0,total:e.total};if(n.data[e.n]=new Uint8Array(e.data),n.count++,this._chunkedData[t]=n,n.total===n.count){delete this._chunkedData[t];let e=kx(n.data);this._handleDataMessage({data:e})}}_send(e,t){let n=vb(e);if(n instanceof Promise)return this._send_blob(n);if(!t&&n.byteLength>this.chunker.chunkedMTU){this._sendChunks(n);return}this._bufferedSend(n)}async _send_blob(e){let t=await e;if(t.byteLength>this.chunker.chunkedMTU){this._sendChunks(t);return}this._bufferedSend(t)}_sendChunks(e){let t=this.chunker.chunk(e);$.log(`DC#${this.connectionId} Try to send ${t.length} chunks...`);for(let e of t)this.send(e,!0)}},uS=class extends cS{_handleDataMessage({data:e}){super.emit(`data`,e)}_send(e,t){this._bufferedSend(e)}constructor(...e){super(...e),this.serialization=Xx.None}},dS=class extends cS{_handleDataMessage({data:e}){let t=this.parse(this.decoder.decode(e)),n=t.__peerData;if(n&&n.type===`close`){this.close();return}this.emit(`data`,t)}_send(e,t){let n=this.encoder.encode(this.stringify(e));if(n.byteLength>=Fx.chunkedMTU){this.emitError(Yx.MessageToBig,`Message too big for JSON channel`);return}this._bufferedSend(n)}constructor(...e){super(...e),this.serialization=Xx.JSON,this.encoder=new TextEncoder,this.decoder=new TextDecoder,this.stringify=JSON.stringify,this.parse=JSON.parse}},fS=class e extends nS{static#e=this.DEFAULT_KEY=`peerjs`;get id(){return this._id}get options(){return this._options}get open(){return this._open}get socket(){return this._socket}get connections(){let e=Object.create(null);for(let[t,n]of this._connections)e[t]=n;return e}get destroyed(){return this._destroyed}get disconnected(){return this._disconnected}constructor(t,n){super(),this._serializers={raw:uS,json:dS,binary:lS,"binary-utf8":lS,default:lS},this._id=null,this._lastServerId=null,this._destroyed=!1,this._disconnected=!1,this._open=!1,this._connections=new Map,this._lostMessages=new Map;let r;if(t&&t.constructor==Object?n=t:t&&(r=t.toString()),n={debug:0,host:Fx.CLOUD_HOST,port:Fx.CLOUD_PORT,path:`/`,key:e.DEFAULT_KEY,token:Fx.randomToken(),config:Fx.defaultConfig,referrerPolicy:`strict-origin-when-cross-origin`,serializers:{},...n},this._options=n,this._serializers={...this._serializers,...this.options.serializers},this._options.host===`/`&&(this._options.host=window.location.hostname),this._options.path&&(this._options.path[0]!==`/`&&(this._options.path=`/`+this._options.path),this._options.path[this._options.path.length-1]!==`/`&&(this._options.path+=`/`)),this._options.secure===void 0&&this._options.host!==Fx.CLOUD_HOST?this._options.secure=Fx.isSecure():this._options.host==Fx.CLOUD_HOST&&(this._options.secure=!0),this._options.logFunction&&$.setLogFunction(this._options.logFunction),$.logLevel=this._options.debug||0,this._api=new oS(n),this._socket=this._createServerConnection(),!Fx.supports.audioVideo&&!Fx.supports.data){this._delayedAbort(qx.BrowserIncompatible,`The current browser does not support WebRTC`);return}if(r&&!Fx.validateId(r)){this._delayedAbort(qx.InvalidID,`ID "${r}" is invalid`);return}r?this._initialize(r):this._api.retrieveId().then(e=>this._initialize(e)).catch(e=>this._abort(qx.ServerError,e))}_createServerConnection(){let e=new eS(this._options.secure,this._options.host,this._options.port,this._options.path,this._options.key,this._options.pingInterval);return e.on(Zx.Message,e=>{this._handleMessage(e)}),e.on(Zx.Error,e=>{this._abort(qx.SocketError,e)}),e.on(Zx.Disconnected,()=>{this.disconnected||(this.emitError(qx.Network,`Lost connection to server.`),this.disconnect())}),e.on(Zx.Close,()=>{this.disconnected||this._abort(qx.SocketClosed,`Underlying socket is already closed.`)}),e}_initialize(e){this._id=e,this.socket.start(e,this._options.token)}_handleMessage(e){let t=e.type,n=e.payload,r=e.src;switch(t){case Qx.Open:this._lastServerId=this.id,this._open=!0,this.emit(`open`,this.id);break;case Qx.Error:this._abort(qx.ServerError,n.msg);break;case Qx.IdTaken:this._abort(qx.UnavailableID,`ID "${this.id}" is taken`);break;case Qx.InvalidKey:this._abort(qx.InvalidKey,`API KEY "${this._options.key}" is invalid`);break;case Qx.Leave:$.log(`Received leave message from ${r}`),this._cleanupPeer(r),this._connections.delete(r);break;case Qx.Expire:this.emitError(qx.PeerUnavailable,`Could not connect to peer ${r}`);break;case Qx.Offer:{let e=n.connectionId,t=this.getConnection(r,e);if(t&&(t.close(),$.warn(`Offer received for existing Connection ID:${e}`)),n.type===Kx.Media){let i=new aS(r,this,{connectionId:e,_payload:n,metadata:n.metadata});t=i,this._addConnection(r,t),this.emit(`call`,i)}else if(n.type===Kx.Data){let i=new this._serializers[n.serialization](r,this,{connectionId:e,_payload:n,metadata:n.metadata,label:n.label,serialization:n.serialization,reliable:n.reliable});t=i,this._addConnection(r,t),this.emit(`connection`,i)}else{$.warn(`Received malformed connection type:${n.type}`);return}let i=this._getMessages(e);for(let e of i)t.handleMessage(e);break}default:{if(!n){$.warn(`You received a malformed message from ${r} of type ${t}`);return}let i=n.connectionId,a=this.getConnection(r,i);a&&a.peerConnection?a.handleMessage(e):i?this._storeMessage(i,e):$.warn(`You received an unrecognized message:`,e);break}}}_storeMessage(e,t){this._lostMessages.has(e)||this._lostMessages.set(e,[]),this._lostMessages.get(e).push(t)}_getMessages(e){let t=this._lostMessages.get(e);return t?(this._lostMessages.delete(e),t):[]}connect(e,t={}){if(t={serialization:`default`,...t},this.disconnected){$.warn(`You cannot connect to a new Peer because you called .disconnect() on this Peer and ended your connection with the server. You can create a new Peer to reconnect, or call reconnect on this peer if you believe its ID to still be available.`),this.emitError(qx.Disconnected,`Cannot connect to new Peer after disconnecting from server.`);return}let n=new this._serializers[t.serialization](e,this,t);return this._addConnection(e,n),n}call(e,t,n={}){if(this.disconnected){$.warn(`You cannot connect to a new Peer because you called .disconnect() on this Peer and ended your connection with the server. You can create a new Peer to reconnect.`),this.emitError(qx.Disconnected,`Cannot connect to new Peer after disconnecting from server.`);return}if(!t){$.error("To call a peer, you must provide a stream from your browser's `getUserMedia`.");return}let r=new aS(e,this,{...n,_stream:t});return this._addConnection(e,r),r}_addConnection(e,t){$.log(`add connection ${t.type}:${t.connectionId} to peerId:${e}`),this._connections.has(e)||this._connections.set(e,[]),this._connections.get(e).push(t)}_removeConnection(e){let t=this._connections.get(e.peer);if(t){let n=t.indexOf(e);n!==-1&&t.splice(n,1)}this._lostMessages.delete(e.connectionId)}getConnection(e,t){let n=this._connections.get(e);if(!n)return null;for(let e of n)if(e.connectionId===t)return e;return null}_delayedAbort(e,t){setTimeout(()=>{this._abort(e,t)},0)}_abort(e,t){$.error(`Aborting!`),this.emitError(e,t),this._lastServerId?this.disconnect():this.destroy()}destroy(){this.destroyed||($.log(`Destroy peer with ID:${this.id}`),this.disconnect(),this._cleanup(),this._destroyed=!0,this.emit(`close`))}_cleanup(){for(let e of this._connections.keys())this._cleanupPeer(e),this._connections.delete(e);this.socket.removeAllListeners()}_cleanupPeer(e){let t=this._connections.get(e);if(t)for(let e of t)e.close()}disconnect(){if(this.disconnected)return;let e=this.id;$.log(`Disconnect peer with ID:${e}`),this._disconnected=!0,this._open=!1,this.socket.close(),this._lastServerId=e,this._id=null,this.emit(`disconnected`,e)}reconnect(){if(this.disconnected&&!this.destroyed)$.log(`Attempting reconnection to server with ID ${this._lastServerId}`),this._disconnected=!1,this._initialize(this._lastServerId);else if(this.destroyed)throw Error(`This peer cannot reconnect to the server. It has already been destroyed.`);else if(!this.disconnected&&!this.open)$.error(`In a hurry? We're still trying to make the initial connection!`);else throw Error(`Peer ${this.id} cannot reconnect because it is not disconnected from the server!`)}listAllPeers(e=e=>{}){this._api.listAllPeers().then(t=>e(t)).catch(e=>this._abort(qx.ServerError,e))}},pS=`rm_v1_`,mS=50;function hS(){let e=``;for(let t=0;t<5;t++)e+=`ABCDEFGHJKLMNPQRSTUVWXYZ23456789`[Math.floor(Math.random()*32)];return e}var gS=class extends EventTarget{constructor({role:e,roomCode:t}){super(),this.role=e,this.roomCode=t||hS(),this.peerId=pS+this.roomCode+(e===`join`?`_`+Math.random().toString(36).slice(2,8):``),this.peer=null,this.connections=new Map,this.outgoingCalls=new Map,this.incomingCalls=new Map,this.audioElements=new Map,this.localMicStream=null,this.lastPoseSend=0}_emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:t}))}_shortId(e){return e.startsWith(pS)?e.slice(6):e}async connect(){return new Promise((e,t)=>{this.peer=new fS(this.peerId,{debug:1}),this.peer.on(`open`,n=>{if(this._emit(`ready`,{peerId:n,roomCode:this.roomCode}),this.role===`join`){let n=pS+this.roomCode,r=this.peer.connect(n,{reliable:!1});this._registerConn(r),r.on(`open`,()=>e()),r.on(`error`,e=>t(e)),setTimeout(()=>t(Error(`Room not found or timed out`)),8e3)}else e()}),this.peer.on(`error`,e=>{this._hasResolved?this._emit(`error`,e):(this._hasResolved=!0,t(e))}),this.peer.on(`connection`,e=>this._registerConn(e)),this.peer.on(`call`,e=>this._handleIncomingCall(e))})}_handleIncomingCall(e){let t=this._shortId(e.peer);try{e.answer()}catch{return}e.on(`stream`,e=>this._attachRemoteAudio(t,e)),e.on(`close`,()=>this._detachRemoteAudio(t)),e.on(`error`,()=>this._detachRemoteAudio(t)),this.incomingCalls.set(t,e)}_attachRemoteAudio(e,t){let n=this.audioElements.get(e);n||(n=document.createElement(`audio`),n.autoplay=!0,n.playsInline=!0,n.dataset.peer=e,n.style.display=`none`,document.body.appendChild(n),this.audioElements.set(e,n)),n.srcObject=t,n.play().catch(()=>{})}_detachRemoteAudio(e){let t=this.audioElements.get(e);if(t){try{t.srcObject=null}catch{}t.remove(),this.audioElements.delete(e)}let n=this.incomingCalls.get(e);if(n){try{n.close()}catch{}this.incomingCalls.delete(e)}}_initiateCall(e){if(!this.localMicStream||this.outgoingCalls.has(e))return;let t=pS+e,n=this.peer.call(t,this.localMicStream);n&&(n.on(`close`,()=>this.outgoingCalls.delete(e)),n.on(`error`,()=>this.outgoingCalls.delete(e)),this.outgoingCalls.set(e,n))}enableMic(e){this.localMicStream=e;for(let e of this.connections.keys())this._initiateCall(e)}disableMic(){for(let[e,t]of this.outgoingCalls)try{t.close()}catch{}if(this.outgoingCalls.clear(),this.localMicStream){for(let e of this.localMicStream.getTracks())e.stop();this.localMicStream=null}}_registerConn(e){let t=this._shortId(e.peer);this.connections.has(t)||(this.connections.set(t,e),e.on(`open`,()=>{if(this._emit(`peer-added`,{peerId:t}),this.role===`host`){let n=Array.from(this.connections.keys()).filter(e=>e!==t).map(e=>pS+e);try{e.send({t:`peers`,ids:n})}catch{}}this.localMicStream&&this._initiateCall(t)}),e.on(`data`,e=>this._handleData(t,e)),e.on(`close`,()=>this._onConnClosed(t)),e.on(`error`,()=>this._onConnClosed(t)))}_onConnClosed(e){if(!this.connections.has(e))return;this.connections.delete(e);let t=this.outgoingCalls.get(e);if(t){try{t.close()}catch{}this.outgoingCalls.delete(e)}this._detachRemoteAudio(e),this._emit(`peer-removed`,{peerId:e})}_handleData(e,t){if(!(!t||typeof t!=`object`))switch(t.t){case`peers`:for(let e of t.ids||[]){let t=this._shortId(e);if(this.connections.has(t)||t===this._shortId(this.peerId))continue;let n=this.peer.connect(e,{reliable:!1});this._registerConn(n)}break;case`pose`:this._emit(`pose`,{peerId:e,landmarks:t.landmarks,aspect:t.aspect});break;case`gesture`:this._emit(`gesture`,{peerId:e,name:t.name,wrist:t.wrist,aspect:t.aspect});break;case`face`:this._emit(`face`,{peerId:e,img:t.img});break}}broadcastFace(e){e&&this._sendAll({t:`face`,img:e})}broadcastPose(e,t){if(!e)return;let n=performance.now();if(n-this.lastPoseSend<mS)return;this.lastPoseSend=n;let r={t:`pose`,landmarks:e.map(e=>({x:+e.x.toFixed(4),y:+e.y.toFixed(4),z:+e.z.toFixed(4),visibility:+(e.visibility??1).toFixed(2)})),aspect:t};this._sendAll(r)}broadcastGesture(e,t,n){if(!t)return;let r={t:`gesture`,name:e,wrist:{x:+t.x.toFixed(4),y:+t.y.toFixed(4),z:+(t.z??0).toFixed(4),visibility:t.visibility??1},aspect:n};this._sendAll(r)}_sendAll(e){for(let t of this.connections.values())if(t.open)try{t.send(e)}catch{}}get peerCount(){return this.connections.size+1}shortSelfId(){return this._shortId(this.peerId)}disconnect(){for(let e of this.connections.values())try{e.close()}catch{}this.connections.clear(),this.disableMic();for(let e of Array.from(this.incomingCalls.keys()))this._detachRemoteAudio(e);if(this.peer)try{this.peer.destroy()}catch{}}},_S=[`Open_Palm`,`Closed_Fist`,`Victory`,`Thumb_Up`,`Pointing_Up`],vS=400,yS=2500,bS=1400,xS=45e3;function SS(e){let t=e>>>0;return function(){t=t+1831565813>>>0;let e=t;return e=Math.imul(e^e>>>15,1|e),e=e+Math.imul(e^e>>>7,61|e)^e,((e^e>>>14)>>>0)/4294967296}}var CS=class extends EventTarget{constructor({stage:e,laneX:t=0}={}){super(),this.stage=e,this.laneX=t,this.active=!1,this.cues=[],this.score=0,this.combo=0,this.maxCombo=0,this.duration=xS,this._tickHandle=null}_emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:t}))}start({seed:e,startAt:t,duration:n=xS}={}){this.active||(this.active=!0,this.score=0,this.combo=0,this.maxCombo=0,this.cues=[],this.duration=n,this.t0=t||performance.now(),this.rng=SS(e??Math.floor(Math.random()*4294967295)),this.nextSpawnAt=this.t0+1500,this.stage.showHitLine(!0),this._tickHandle=setInterval(()=>this._tick(),40),this._emit(`update`,{score:0,combo:0,timeLeft:this.duration}))}stop(){if(this.active){this.active=!1,clearInterval(this._tickHandle),this._tickHandle=null,this.stage.showHitLine(!1);for(let e of this.cues)this.stage.destroyCue(e.id);this.cues=[],this._emit(`end`,{score:this.score,maxCombo:this.maxCombo})}}_tick(){let e=performance.now(),t=e-this.t0,n=Math.max(0,this.duration-t);if(t>this.duration){this.stop();return}for(;this.nextSpawnAt<=e&&this.nextSpawnAt+yS<=this.t0+this.duration;){let e=_S[Math.floor(this.rng()*_S.length)],t=this.nextSpawnAt+yS,n=this.stage.spawnCue(e,this.nextSpawnAt,t,this.laneX);this.cues.push({id:n,gesture:e,hitAt:t,scored:!1,result:null}),this.nextSpawnAt+=bS*(.9+this.rng()*.35)}for(let t of this.cues)!t.scored&&e>t.hitAt+vS&&(t.scored=!0,t.result=`miss`,this.combo=0,this.stage.markCue(t.id,`miss`),this._emit(`update`,{score:this.score,combo:this.combo,timeLeft:n}));this.cues=this.cues.filter(t=>!t.scored||e<t.hitAt+900),this._emit(`tick`,{timeLeft:n})}onLocalGesture(e){if(!this.active)return;let t=performance.now(),n=null,r=1/0;for(let e of this.cues){if(e.scored)continue;let i=Math.abs(t-e.hitAt);i>vS||i<r&&(n=e,r=i)}if(n){if(n.scored=!0,n.gesture===e){n.result=`hit`,this.combo+=1,this.maxCombo=Math.max(this.maxCombo,this.combo);let e=Math.min(this.combo,8)*10;this.score+=100+e,this.stage.markCue(n.id,`hit`)}else n.result=`wrong`,this.combo=0,this.score=Math.max(0,this.score-20),this.stage.markCue(n.id,`wrong`);this._emit(`update`,{score:this.score,combo:this.combo,timeLeft:Math.max(0,this.duration-(t-this.t0))})}}},wS=document.getElementById(`video`),TS=document.getElementById(`scene`),ES=document.getElementById(`lobby`),DS=document.getElementById(`host-btn`),OS=document.getElementById(`join-form`),kS=document.getElementById(`join-code`),AS=document.getElementById(`lobby-status`),jS=document.getElementById(`room-info`),MS=document.getElementById(`room-code`),NS=document.getElementById(`copy-link`),PS=document.getElementById(`mic-toggle`),FS=document.getElementById(`face-toggle`),IS=document.getElementById(`peer-count`),LS=document.getElementById(`gesture-label`),RS=document.getElementById(`game-btn`),zS=document.getElementById(`countdown`),BS=document.getElementById(`game-hud`),VS=document.getElementById(`game-score`),HS=document.getElementById(`game-combo`),US=document.getElementById(`game-timer`),WS=document.getElementById(`game-end`),GS=document.getElementById(`end-score-val`),KS=document.getElementById(`end-combo-val`),qS=document.getElementById(`end-close`),JS=null,YS=null,XS=null,ZS=null,QS=null,$S=window.location.hash.match(/room=([A-Z0-9]+)/i);$S&&(kS.value=$S[1].toUpperCase()),DS.addEventListener(`click`,()=>cC({role:`host`})),OS.addEventListener(`submit`,e=>{e.preventDefault();let t=kS.value.trim().toUpperCase();t&&cC({role:`join`,roomCode:t})}),PS.addEventListener(`click`,async()=>{if(YS)if(PS.getAttribute(`aria-pressed`)!==`true`){PS.disabled=!0;try{let e=await navigator.mediaDevices.getUserMedia({audio:{echoCancellation:!0,noiseSuppression:!0,autoGainControl:!0}});YS.enableMic(e),PS.setAttribute(`aria-pressed`,`true`),PS.textContent=`mic: on`}catch(e){console.error(e),alert(`Microphone error: `+(e?.message||e))}finally{PS.disabled=!1}}else YS.disableMic(),PS.setAttribute(`aria-pressed`,`false`),PS.textContent=`mic: off`});function eC(e){XS&&(XS.faceEnabled=e,FS.setAttribute(`aria-pressed`,String(e)),FS.querySelector(`.left`).classList.toggle(`active`,!e),FS.querySelector(`.right`).classList.toggle(`active`,e),e||(JS.clearFace(ZS),YS.broadcastFace(``)))}FS.addEventListener(`click`,e=>{if(!XS)return;let t=e.target.closest(`.opt`);eC(t?t.classList.contains(`right`):!XS.faceEnabled)}),FS.addEventListener(`keydown`,e=>{(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),XS&&eC(!XS.faceEnabled))}),NS.addEventListener(`click`,async()=>{try{await navigator.clipboard.writeText(window.location.href),NS.textContent=`copied!`,setTimeout(()=>NS.textContent=`copy link`,1500)}catch{NS.textContent=`failed`}}),window.addEventListener(`keydown`,e=>{(e.key===`v`||e.key===`V`)&&wS.classList.toggle(`visible`),(e.key===`f`||e.key===`F`)&&(document.fullscreenElement?document.exitFullscreen():document.documentElement.requestFullscreen())});function tC(e,t=!1){AS.textContent=e,AS.classList.toggle(`error`,t)}function nC(e){DS.disabled=e,kS.disabled=e,OS.querySelector(`button[type=submit]`).disabled=e}function rC(){let e=YS?YS.peerCount:1;IS.textContent=e===1?`1 player`:`${e} players`}function iC(e){LS.textContent=e.replace(/_/g,` `),LS.classList.add(`active`),clearTimeout(iC._t),iC._t=setTimeout(()=>LS.classList.remove(`active`),550)}function aC(e){return new Promise(t=>setTimeout(t,e))}async function oC(){zS.classList.remove(`hidden`);for(let e=3;e>=1;e--)zS.textContent=String(e),zS.classList.remove(`pop`),zS.offsetWidth,zS.classList.add(`pop`),await aC(800);zS.textContent=`GO`,zS.classList.remove(`pop`),zS.offsetWidth,zS.classList.add(`pop`),await aC(600),zS.classList.add(`hidden`)}async function sC(){if(!JS||!ZS||QS?.active)return;RS.disabled=!0,WS.classList.add(`hidden`);let e=JS.robotsByPeer.get(ZS)?.group.position.x??0;QS=new CS({stage:JS,laneX:e}),QS.addEventListener(`update`,e=>{VS.textContent=e.detail.score,HS.textContent=`×`+e.detail.combo,US.textContent=Math.ceil(e.detail.timeLeft/1e3)}),QS.addEventListener(`tick`,e=>{US.textContent=Math.ceil(e.detail.timeLeft/1e3)}),QS.addEventListener(`end`,e=>{BS.classList.add(`hidden`),GS.textContent=e.detail.score,KS.textContent=e.detail.maxCombo,WS.classList.remove(`hidden`),RS.disabled=!1}),await oC(),BS.classList.remove(`hidden`),VS.textContent=`0`,HS.textContent=`×0`,US.textContent=`45`,QS.start({seed:Date.now()&4294967295,duration:45e3})}RS.addEventListener(`click`,sC),qS.addEventListener(`click`,()=>WS.classList.add(`hidden`));async function cC({role:e,roomCode:t}){nC(!0),tC(e===`host`?`Creating room…`:`Joining ${t}…`);try{YS=new gS({role:e,roomCode:t}),await YS.connect()}catch(e){console.error(e),tC(e?.message||`Connection failed`,!0),nC(!1),YS=null;return}ZS=YS.shortSelfId(),window.history.replaceState(null,``,`#room=${YS.roomCode}`),MS.textContent=YS.roomCode,jS.classList.remove(`hidden`),JS=new hu({canvas:TS}),JS.addRobot(ZS),YS.addEventListener(`peer-added`,e=>{JS.addRobot(e.detail.peerId),rC()}),YS.addEventListener(`peer-removed`,e=>{JS.removeRobot(e.detail.peerId),rC()}),YS.addEventListener(`pose`,e=>{let{peerId:t,landmarks:n,aspect:r}=e.detail;JS.setPose(t,n,r)}),YS.addEventListener(`gesture`,e=>{let{peerId:t,name:n,wrist:r,aspect:i}=e.detail;JS.triggerEffect(t,n,r,i),iC(n)}),YS.addEventListener(`face`,e=>{let{peerId:t,img:n}=e.detail;n?JS.setFace(t,n):JS.clearFace(t)}),tC(`Starting camera…`);try{XS=new mb({video:wS}),XS.onPose=(e,t)=>{if(!e){JS.hidePeer(ZS);return}JS.setPose(ZS,e,t),YS.broadcastPose(e,t)},XS.onGesture=(e,t,n)=>{let r=t?.[0];r&&(JS.triggerEffect(ZS,e,r,n),YS.broadcastGesture(e,r,n),iC(e),QS?.active&&QS.onLocalGesture(e))},XS.onFace=e=>{JS.setFace(ZS,e),YS.broadcastFace(e)},await XS.start()}catch(e){console.error(e),tC(`Camera error: `+(e?.message||e),!0),nC(!1);return}JS.start(),ES.classList.add(`hidden`),rC()}